...
console.log("Snakes - " + boxWidth, boxWidthRatio);
...
function draw() {
  if (snake[0].x % boxWidth == 0 && snake[0].y % boxWidth == 0) {
    // chnage Snake direction only when it at 0,0 of new box
  ...
  for (let i = snake.length - 1; i >= 0; i--) {
    if (i == 0) {
      ...
      ctx.fillRect(
        (snake[i].x / boxWidth) * boxWidthRatio,
        (snake[i].y / boxWidth) * boxWidthRatio,
        boxWidthRatio,
        boxWidthRatio
      );
      ctx.fillStyle = "black";
      ...
      if (d == "down") {
        ctx.arc(
          (snake[i].x / boxWidth) * boxWidthRatio + (1.5 * boxWidthRatio) / 5,
          (snake[i].y / boxWidth) * boxWidthRatio + (4 * boxWidthRatio) / 5,
          boxWidthRatio / 8,
          0,
          2 * Math.PI
        );
        ctx.arc(
          (snake[i].x / boxWidth) * boxWidthRatio + (3.5 * boxWidthRatio) / 5,
          (snake[i].y / boxWidth) * boxWidthRatio + (4 * boxWidthRatio) / 5,
          boxWidthRatio / 8,
          0,
          2 * Math.PI
        ...
        ctx.arc(
          (snake[i].x / boxWidth) * boxWidthRatio + (3.5 * boxWidthRatio) / 5,
          (snake[i].y / boxWidth) * boxWidthRatio + (3.5 * boxWidthRatio) / 5,
          boxWidthRatio / 8,
          0,
          2 * Math.PI
        );
        ctx.arc(
          (snake[i].x / boxWidth) * boxWidthRatio + (3.5 * boxWidthRatio) / 5,
          (snake[i].y / boxWidth) * boxWidthRatio + (1.5 * boxWidthRatio) / 5,
          boxWidthRatio / 8,
          0,
          2 * Math.PI
        );
        ...
        ctx.arc(
          (snake[i].x / boxWidth) * boxWidthRatio + (1.5 * boxWidthRatio) / 5,
          (snake[i].y / boxWidth) * boxWidthRatio + boxWidthRatio / 5,
          boxWidthRatio / 8,
          0,
          2 * Math.PI
        );
  ...
  ctx.beginPath();
  ctx.arc(
    (food.x / boxWidth) * boxWidthRatio + boxWidthRatio / 2,
    (food.y / boxWidth) * boxWidthRatio + boxWidthRatio / 2,
    boxWidthRatio / 2,
    0,
    2 * Math.PI
  );
...
function collisionHead() {
  ...
  return (
    snake[0].x > 23 * boxWidth ||
    snake[0].x < 0 ||
    snake[0].y < 3 * boxWidth ||
    snake[0].y > 23 * boxWidth
  );
}
